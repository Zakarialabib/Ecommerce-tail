...
@section('title','leMotoShop || Banner Page')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">{{ __('Banners List')}}</h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="#delModal{{$user->id}}Label">{{ __('Delete user')}}</h5>
        ...
        @else
          <h6 class="text-center">{{ __('No banners found')}}!!! {{ __('Please create banner')}}</h6>
        @endif
      </div>
    </div>
</div>
