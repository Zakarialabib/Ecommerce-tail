...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          <label for="quote" class="col-form-label">{{ __('Quote')}}</label>
        ...
        <div class="form-group">
          <label for="post_cat_id">{{ __('Category')}} <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          <select name="tags[]" multiple  data-live-search="true" class="form-control selectpicker">
              <option value="">--{{ __('Select any tag')}}--</option>
        ...
        <div class="form-group">
          <label for="added_by">{{ __('Author')}}</label>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            <option value="active" {{(($post->status=='active')? 'selected' : '')}}>{{ __('Active')}}</option>
            <option value="inactive" {{(($post->status=='inactive')? 'selected' : '')}}>{{ __('Inactive')}}</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
