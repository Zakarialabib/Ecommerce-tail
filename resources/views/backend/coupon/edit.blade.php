...
<div class="card">
    <h5 class="card-header">{{ __('Edit Coupon')}}</h5>
    <div class="card-body">
      <form method="post" action="{{route('coupon.update',$coupon->id)}}">
        @csrf 
        @method('PATCH')
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">{{ __('Coupon Code')}} <span class="text-danger">*</span></label>
          ...
          <div class="form-group">
              <label for="type" class="col-form-label">{{ __('Type')}} <span class="text-danger">*</span></label>
          ...
          <div class="form-group">
              <label for="inputTitle" class="col-form-label">{{ __('Value')}} <span class="text-danger">*</span></label>
