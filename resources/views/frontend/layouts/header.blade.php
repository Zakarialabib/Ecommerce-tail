            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            ...
                            @endphp
                            <li>@foreach($settings as $data) <i class="ti-headphone-alt"></i> <a href="tel:{{$data->phone}}"> {{$data->phone}} </a> @endforeach</li>
                            <li>@foreach($settings as $data) <i class="ti-email"></i> <a href="mailto:{{$data->email}}"> {{$data->email}} </a> @endforeach</li>
                        </ul>
                    </div>
                    <!--/ End Top Left -->
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                        <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">{{ __('Track Order')}}</a></li>
                            {{-- <li><i class="ti-alarm-clock"></i> <a href="#">{{ __('Daily deal')}}</a></li> --}}
                            @auth 
                                @if(Auth::user()->role=='admin')
                                    <li><i class="ti-user"></i> <a href="{{route('admin')}}"  target="_blank">{{ __('Dashboard')}}</a></li>
                                @else 
                                    <li><i class="ti-user"></i> <a href="{{route('user')}}"  target="_blank">{{ __('Dashboard')}}</a></li>
                                @endif
                                <li><i class="ti-power-off"></i> <a href="{{route('user.logout')}}">{{ __('Logout')}}</a></li>

                            @else
                                <li><i class="ti-power-off"></i><a href="{{route('login.form')}}">{{ __('Login')}} /</a> <a href="{{route('register.form')}}">{{ __('Register')}}</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        ...
                                        <a href="{{route('wishlist')}}">{{ __('View Wishlist')}}</a>
                                    </div>
