										...
										<div class="product-info">
											<div class="nav-main">
												...
												<ul class="nav nav-tabs" id="myTab" role="tablist">
													<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#description" role="tab">{{ __('Description')}}</a></li>
														...
														<div class="row">
															<div class="col-12">
																...
																<p class="text-center p-5">
																	You need to <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">{{ __('Login')}}</a> OR <a style="color:blue" href="{{route('register.form')}}">Register</a>
