                ...
                <!-- Product Slider -->
                 <div class="product-details-tab">
                        ...
                        <div class="pro-dec-big-img-slider">
                            ...
                            <a class="easyzoom-pop-up img-popup" href="{{ $photo }}"><i class="icon-size-fullscreen"></i>
                            </a>
                            </div>
                            @endforeach
                            <!-- End Images slider -->
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product-details-content pro-details-content-mrg">
                        ...
                        <div class="pro-details-price">
                            ...
                            @endphp
                            <p class="price"><span class="discount">{{ Helper::showCurrencyPrice($after_discount,2) }}</span>
                                <s> {{ Helper::showCurrencyPrice($product_detail->price,2) }}</s>
                            </p>
                        </div>
                        <!--/ End Description -->
                        <!-- Color -->
                        ...
                        <div class="single-product-wrap">
                            ...
                            <div class="product-content-wrap-2 text-center">
                                ...
                                <div class="product-price-2">
                                    ...
                                    @endphp
                                    <span class="old">{{ Helper::showCurrencyPrice($data->price,2) }}</span>
                                    <span>{{ Helper::showCurrencyPrice($after_discount,2) }}</span>
                                </div>
                            </div>
                            <div class="product-content-wrap-2 product-content-position text-center">
                                ...
                                <div class="data-price-2">
                                    ...
                                    <del class="old-price">{{ Helper::showCurrencyPrice($data->price,2) }}</del>
                                </div>
